...
public class LifeCycleMonitor {
	...
	public void beanErzeugt(InvocationContext ic) {
		System.out.println("Es wurde eine Bean vom Typ "
				+ ic.getTarget().getClass().getName() + " erzeugt.");
	}

	@PreDestroy
	public void beanEntfernt(InvocationContext ic) {
		System.out.println("Es wird eine Bean vom Typ "
				+ ic.getTarget().getClass().getName() + " entfernt.");
	}
}
